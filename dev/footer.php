        <footer id="about">
          ...
          <div id="footer-brasil" class="footer-logos">
              <div>
                  <a href="http://www.acessoainformacao.gov.br/" class="logo-acesso">
                      <img src="/++theme++azul/img/acesso-a-infornacao.png" alt="Acesso a Informação"></a>
                  <a href="http://www.brasil.gov.br/" class="logo-brasil">
                      <img src="/++theme++azul/img/brasil.png" alt="Brasil - Governo Federal"></a>
              </div>
          </div>
          <div class="extra-footer">
              <div class="container">
                <div class="row">
                  <div class="col-md-3">
                    <img src="assets/img/min-saude.jpg" alt="" class="img-responsive  center-block">
                  </div>
                  <div class="col-md-3">
                    <img src="assets/img/sus1.jpg" alt="" class="img-responsive  center-block">
                  </div>
                  <div class="col-md-2">
